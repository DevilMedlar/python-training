...
| Learning explicitly begins | Use diagnostic placement to identify strengths and gaps. | Skipping lessons or granting credit from placement. |
...
| Occasional quiz | Sample taught current and older topics at varied points. | A quiz after every lesson or output-guessing drills. |
| Phase ends | Test conceptual and practical understanding; review results. | Treating an optional project or CI run as the phase test. |
